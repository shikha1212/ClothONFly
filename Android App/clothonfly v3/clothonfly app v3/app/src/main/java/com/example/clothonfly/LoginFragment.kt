...
class LoginFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Inflate the layout for this fragment - all elemenst of the xml is accessible here
        ...
        view.login_button.setOnClickListener {
            doAsync {
                ...
                val gotresponse = validate_user(user_name_var, password_var)
                val json = JSONObject(gotresponse)
                    if (json.get("role") == "Buyer") {
                        Global.setUserName(user_name_var)
                        (activity as NavigationHost).navigateTo(BuyerHome(), addToBackstack = false)
