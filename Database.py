...
class Database():
    ...
    def create_tables(self):
        ...
        db = connect.cursor()
        # db.execute(
        #     '''CREATE TABLE Users(User_ID INTEGER PRIMARY KEY AutoIncrement,User_Name Text NOT NULL UNIQUE,Password Text,User_Type Text Not Null check(User_Type = "Admin" or User_Type = "Buyer" or User_Type = "Seller"), First_Name TEXT NOT NULL,
